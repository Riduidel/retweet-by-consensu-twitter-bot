...
[plantuml, {plantumldir}bot-container, svg, opts="interactive"]     
----
include::{structurizrdir}/bot-container.plantuml[]
----

Application is in fact quite simple: 
a simple container contains the various responsible for connecting to the various twitter timelines 
and to read/write content in those timelines. Let's detail things a little ...

[plantuml, {plantumldir}bot-components, svg, opts="interactive"]     
----
include::{structurizrdir}/bot-components.plantuml[]
----
